...
BEGIN {
    $Net::WAMP::Client::Features::FEATURES{'caller'}{'features'}{'call_canceling'} = $Types::Serialiser::true;
    $Net::WAMP::Client::Features::FEATURES{'caller'}{'features'}{'progressive_call_results'} = $Types::Serialiser::true;
}
